...
catalogue of reusable workflows / templates (description, usage example, and
a link to the generated inputs/secrets/outputs reference) see
[README.md](../README.md); for local setup, linting, and testing changes see
...
| `docs/workflows/*.md` | Generated by `actdocs` from each `workflow_call` file's own inputs/secrets/outputs -- never hand-edit, see DEVELOPMENT.md |
